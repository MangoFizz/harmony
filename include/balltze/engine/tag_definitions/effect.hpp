...
#ifndef BALLTZE_API__ENGINE__TAG_DEFINITION__EFFECT_HPP
...
namespace Balltze::Engine::TagDefinitions { 
	...
	struct EffectPart {
		EffectCreateIn create_in;
		EffectViolenceMode violence_mode;
		Index location;
		EffectPartFlags flags;
		PADDING(12);
		std::uint32_t type_class;
		TagDependency type;
		PADDING(24);
	...
	struct EffectParticle {
		...
		EffectDistributionFunction distribution_function;
		PADDING(2);
		std::int16_t count[2];
