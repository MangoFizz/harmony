...
namespace Harmony {
    ...
    public:
         ...
         */
        Command(const char *name, const char *category, const char *help, CommandFunction function, bool autosave, std::size_t min_args, std::size_t max_args);
         ...
         */
        Command(const char *name, const char *category, const char *help, CommandFunction function, bool autosave, std::size_t args = 0);

        /**
        * Get commands for current engine
        */
        static std::vector<Command> get_commands() noexcept;
