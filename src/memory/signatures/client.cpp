...
namespace Harmony {
    std::vector<Signature> find_client_signatures() {
        ...
        FIND_SIGNATURE("on_map_load", 0x0, {/*0xE8*/ -1, -1, -1, -1, -1, 0xE8, -1, -1, -1, -1, 0xA1, -1, -1, -1, -1, 0x33, 0xD2, 0x8B, 0xC8, 0x89, 0x11});
        ...
        FIND_SIGNATURE("console_command_function", 0x0, {-1, -1, -1, -1, -1, -1, -1, -1, 0x3C, 0x3B, 0x74, 0x0E, 0x3C, 0x23, 0x74, 0x0A, 0x3C, 0x2F});
        ...
        FIND_SIGNATURE("multiplayer_hit_sound_volume", 0x2, {0xD9, -1, -1, -1, -1, 0x00, 0xDA, 0xE9, 0xDF, 0xE0, 0xF6, 0xC4, 0x44, 0x7B, 0x39});
        FIND_SIGNATURE("multiplayer_hit_sound_volume_check", 0x3, {0xF6, 0xC4, 0x44, 0x7B, 0x39, 0xA1, -1, -1, -1, -1, 0x8B, 0x0D, -1, -1, -1, -1, 0x8B, 0x51, 0x0C});
        FIND_SIGNATURE("multiplayer_hit_sound_call", 0x0, {0xE8, -1, -1, -1, -1, 0x8B, 0x15, 0x70, 0xCD, 0x68, 0x00, 0x8B, 0x42, 0x0C, 0x83, 0xC4, 0x04, 0x5F, 0xA3, 0x30, 0x39, 0x65, 0x00});
        ...
        /** Debug */
        FIND_SIGNATURE("client_player_update_history_entry_write_function", 0x0, {0x81, 0xEC, 0x00, 0x04, 0x00, 0x00, 0x85, 0xC9, 0x75, 0x0C, 0x8B, 0x0D, -1, -1, -1, -1, 0x23, 0xC8, 0x3B, 0xC8});
